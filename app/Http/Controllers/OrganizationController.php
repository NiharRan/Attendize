...
{
    public function showOrganizers(Request $request, $organiser_id)
    {
        ...
        $organizations = $organizations->orderBy( $sort_by, $sort_order)
            ->paginate();
        ...
        return view('ManageOrganiser.Organizations', $data);
    }
    /**
